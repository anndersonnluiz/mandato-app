...
export class ApiGameRepository {
  ...
  advanceUntil(id: string, mode: 'DECISION' | 'NOTIFICATION' | 'MONTH' | 'WEEK', operationId?: string): Observable<GameViewContract & { advanceSummary?: { daysAdvanced: number; mode: string } }> {
